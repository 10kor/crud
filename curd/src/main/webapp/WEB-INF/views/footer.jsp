<div class="container">
	<footer class="py-3 my-4 border-top">
		<div class="nav justify-content-center pb-3 mb-3">
			<span class="mb-3 mb-md-0 text-body-secondary">© 2023 All Rights Reserved</span>
		</div>
		<ul class="nav justify-content-center pb-3 mb-3">
			<li class="ms-3"><a class="text-body-secondary"
				href="https://github.com/10kor"> <svg
			...
			<li class="ms-3"><a class="text-body-secondary"
				href="https://velog.io/@pdi9450"> <svg
						xmlns="http://www.w3.org/2000/svg" width="30" height="30"
						fill="currentColor" class="bi bi-file-earmark-richtext-fill"
						viewBox="0 0 16 16">
		  <path
			...
			<li class="ms-3"><a class="text-body-secondary"
				href="mailto:pdi9450@gmail.com"> <svg
						xmlns="http://www.w3.org/2000/svg" width="30" height="30"
						fill="currentColor" class="bi bi-envelope-at-fill"
						viewBox="0 0 16 16">
		  <path
